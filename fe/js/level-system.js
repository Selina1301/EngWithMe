...
(function (global) {
   ...
   */
  const LEVEL_TITLES = [
    { minLevel: 500, title: "🌌 Bậc Thầy Tối Cao", color: "linear-gradient(135deg, #00f0ff, #a855f7, #ec4899, #ffd700)", border: "rgba(0, 240, 255, 0.8)" },
    { minLevel: 400, title: "👑 Chí Tôn Ngôn Ngữ", color: "linear-gradient(135deg, #ffd700, #ec4899, #a855f7)", border: "rgba(255, 215, 0, 0.8)" },
    { minLevel: 270, title: "⚡ Tri Thức Thần Thoại", color: "linear-gradient(135deg, #38bdf8, #a855f7, #00f0ff)", border: "rgba(56, 189, 248, 0.8)" },
    { minLevel: 200, title: "💎 Thần Thoại Bất Tử", color: "linear-gradient(135deg, #a855f7, #ec4899, #00f0ff)", border: "rgba(236, 72, 153, 0.6)" },
    { minLevel: 150, title: "🔥 Bá Chủ Ngôn Ngữ", color: "linear-gradient(135deg, #ef4444, #f97316, #eab308)", border: "rgba(249, 115, 22, 0.6)" },
    { minLevel: 100, title: "🌟 Đại Sứ Tiếng Anh", color: "linear-gradient(135deg, #ffd700, #3b82f6, #00f0ff)", border: "rgba(255, 215, 0, 0.6)" },
    ...
    { minLevel: 30,  title: "👑 Huyền Thoại", color: "linear-gradient(135deg, #ffd700, #ff8c00)", border: "rgba(255, 215, 0, 0.6)" },
  ...
  function getXpForLevel(level) {
    ...
    // Every 70 levels adds +20 XP over previous tier requirement
