...
try {
    ...
    add_user_notification((int)$currentUser['id'], "Mật khẩu vừa thay đổi", "Mật khẩu tài khoản EngWithMe của bạn vừa được thay đổi thành công.", "security", "danger", "profile.html#security");
