...
app.all("/v1/payments.php", forwardTo(adminApp, "admin"));
app.all("/v1/admin/payments.php", forwardTo(adminApp, "admin"));
app.all("/v1/update_order_status.php", forwardTo(adminApp, "admin"));
app.all("/v1/admin/update_order_status.php", forwardTo(adminApp, "admin"));
app.all("/v1/clear_test_orders.php", forwardTo(adminApp, "admin"));
app.all("/v1/admin/clear_test_orders.php", forwardTo(adminApp, "admin"));

app.all("/v1/learning_content.php", forwardTo(learningApp, "learning"));
app.all("/v1/sync_progress.php", forwardTo(learningApp, "learning"));
app.all("/v1/sync_vocab.php", forwardTo(learningApp, "learning"));
app.all("/v1/sync_grammar.php", forwardTo(learningApp, "learning"));
app.all("/v1/user_level.php", forwardTo(learningApp, "learning"));
app.all("/v1/send_contact.php", forwardTo(learningApp, "learning"));
